...
contract MoodNft is ERC721 {
    //errors
    error cannotFlipMoodIfNotOwner();
    ...
    constructor(string memory sadSvgImageUri, string memory happySvgImageURI) ERC721("Mood NFT","MNFT"){
        s_tokenCounter=0;
    ...
    function flipMood(uint256 tokenId) public{
        ...
        if (!_isAuthorized(msg.sender, msg.sender, tokenId)){
            revert cannotFlipMoodIfNotOwner();
